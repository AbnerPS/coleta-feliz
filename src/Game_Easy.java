...
public class Game_Easy extends JFrame implements KeyListener { // Implementa JFrame para parte visual e KeyListener para
	...
	public void inicializar() {
		...
		lblSobre.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				JOptionPane.showMessageDialog(null, (new ImageIcon(
						...
						"C:\\Users\\Abner\\Documents\\Atividades%20Pr%C3%A1ticas%20Supervisionadas\\3º Semestre\\ColetaFeliz\\src\\Splash.png")),
		...
		lblIconLogo.setIcon(new ImageIcon(
				//"C:\\Users\\geova\\OneDrive\\Documentos\\APS_coleta\\3º Semestre\\ColetaFeliz\\src\\IconPerson.png",
	...
	public void keyPressed(KeyEvent e) { // método para quando uma tecla for pressionada
		...
		if (e.getKeyCode() == e.VK_LEFT) {
			lblBola.setIcon(new ImageIcon(
					//"C:\\Users\\geova\\OneDrive\\Documentos\\APS_coleta\\3º Semestre\\ColetaFeliz\\src\\left.gif",
					"C:\\Users\\Abner\\Documents\\Atividades%20Pr%C3%A1ticas%20Supervisionadas\\3º Semestre\\ColetaFeliz\\src\\left.gif"));
			if (xObj <= 0) {
			} else if ((yObj >= lblNaoReciclavel.getY() - 50) && (xObj <= lblNaoReciclavel.getX() + 55)) { // colisão de
																											// direita
																											// com não
																											// reciclacel
				...
				// correspondente adiciona pontos, senão subtrai 1 ponto
				if (pnrec >= 1) {
					pontos += pnrec;
					pnrec = 0;
					...
					&& ((xObj <= lblOrganico.getX() + 55) && (xObj >= lblOrganico.getX()))) { // colisão de direita com
																								// organico
				...
				if (porganico >= 1) {
					...
					&& ((xObj <= lblPapel.getX() + 50) && (xObj >= lblPapel.getX()))) { // colisão de direita com papel
				...
				if (ppapel >= 1) {
					...
					&& ((yObj <= lblReciclavel.getY() + 25) && (yObj >= lblReciclavel.getY() - 45))) { // colisão de
																										// direita com
																										// reciclavel
		...
		if (e.getKeyCode() == e.VK_RIGHT) {
			lblBola.setIcon(new ImageIcon(
					//"C:\\Users\\geova\\OneDrive\\Documentos\\APS_coleta\\3º Semestre\\ColetaFeliz\\src\\right.gif",
					"C:\\Users\\Abner\\Documents\\Atividades%20Pr%C3%A1ticas%20Supervisionadas\\3º Semestre\\ColetaFeliz\\src\\right.gif"));
			if (xObj >= 555) {
			} else if ((xObj >= lblVidro.getX() - 38) && (yObj <= lblVidro.getY() + 48)) { // colisão de esquerda com
																							// vidro
				...
				if (pvidro >= 1) {
					...
					&& ((yObj <= lblMetal.getY() + 48) && (yObj >= lblMetal.getY() - 48))) { // colisão de esquerda com
																								// metal
				...
				if (pmetal >= 1) {
					...
					&& ((yObj <= lblPlastico.getY() + 48) && (yObj >= lblPlastico.getY() - 48))) { // colisão de
																									// esquerda com
																									// plastico
				...
				if (pplastico >= 1) {
					...
					&& ((xObj <= lblOrganico.getX()) && (xObj >= lblOrganico.getX() - 30))) { // colisão de esquerda com
																								// organico
				JOptionPane.showMessageDialog(null, "DEPOSITADO ORGANICO");
				// se coletado 1 ou mais reciclaveis deste tipo e tocar na lixeira
				// correspondente adiciona pontos, senão subtrai 1 ponto
			...
			else if ((yObj >= lblPapel.getY() - 40) && ((xObj <= lblPapel.getX()) && (xObj >= lblPapel.getX() - 40))) { // colisão
																														// de
																														// esquerda
																														// com
																														// papel
		...
		if (e.getKeyCode() == e.VK_UP) {
			lblBola.setIcon(new ImageIcon(
					//"C:\\Users\\geova\\OneDrive\\Documentos\\APS_coleta\\3º Semestre\\ColetaFeliz\\src\\up.gif",
					"C:\\Users\\Abner\\Documents\\Atividades%20Pr%C3%A1ticas%20Supervisionadas\\3º Semestre\\ColetaFeliz\\src\\up.gif"));
			if (yObj <= 115) {
			} else if ((xObj >= lblVidro.getX() - 28) && (yObj <= lblVidro.getY() + 58)) { // colisão de baixo com vidro
				JOptionPane.showMessageDialog(null, "DEPOSITADO VIDRO");
				// se coletado 1 ou mais reciclaveis deste tipo e tocar na lixeira
				// correspondente adiciona pontos, senão subtrai 1 ponto
				if (pvidro >= 1) {
					...
					&& ((yObj <= lblMetal.getY() + 58) && (yObj >= lblMetal.getY() - 58))) { // colisão de baixo com
																								// metal
				JOptionPane.showMessageDialog(null, "DEPOSITADO METAL");
				// se coletado 1 ou mais reciclaveis deste tipo e tocar na lixeira
				// correspondente adiciona pontos, senão subtrai 1 ponto
				if (pmetal >= 1) {
					...
					&& ((yObj <= lblPlastico.getY() + 58) && (yObj >= lblPlastico.getY() - 58))) { // colisão de baixo
																									// com plastico
				JOptionPane.showMessageDialog(null, "DEPOSITADO PLASTICO");
				// se coletado 1 ou mais reciclaveis deste tipo e tocar na lixeira
				// correspondente adiciona pontos, senão subtrai 1 ponto
				if (pplastico >= 1) {
					...
					&& ((yObj <= lblReciclavel.getY() + 40) && (yObj >= lblReciclavel.getY()))) { // colisão de baixo
																									// com reciclavel
		...
		if (e.getKeyCode() == e.VK_DOWN) {
			lblBola.setIcon(new ImageIcon(
					//"C:\\Users\\geova\\OneDrive\\Documentos\\APS_coleta\\3º Semestre\\ColetaFeliz\\src\\down.gif",
					"C:\\Users\\Abner\\Documents\\Atividades%20Pr%C3%A1ticas%20Supervisionadas\\3º Semestre\\ColetaFeliz\\src\\down.gif"));
			if (yObj >= 440) {
			} else if ((xObj >= lblMetal.getX() - 25)
					&& ((yObj <= lblMetal.getY() + 58) && (yObj >= lblMetal.getY() - 58))) { // colisão de cima com
																								// metal
				JOptionPane.showMessageDialog(null, "DEPOSITADO METAL");
				// se coletado 1 ou mais reciclaveis deste tipo e tocar na lixeira
				// correspondente adiciona pontos, senão subtrai 1 ponto
				if (pmetal >= 1) {
					...
					&& ((yObj <= lblPlastico.getY() + 58) && (yObj >= lblPlastico.getY() - 58))) { // colisão de cima
																									// com plastico
				JOptionPane.showMessageDialog(null, "DEPOSITADO PLASTICO");
				// se coletado 1 ou mais reciclaveis deste tipo e tocar na lixeira
				// correspondente adiciona pontos, senão subtrai 1 ponto
			...
			else if ((yObj >= lblNaoReciclavel.getY() - 50) && (xObj <= lblNaoReciclavel.getX() + 48)) { // colisão de
																											// cima com
																											// não
																											// reciclacel
				JOptionPane.showMessageDialog(null, "DEPOSITADO NÃO RECICLAVEL");
				...
				if (pnrec >= 1) {
					...
					&& ((xObj <= lblOrganico.getX() + 40) && (xObj >= lblOrganico.getX() - 20))) { // colisão de cima
																									// com organico
				JOptionPane.showMessageDialog(null, "DEPOSITADO ORGANICO");
				// se coletado 1 ou mais reciclaveis deste tipo e tocar na lixeira
				// correspondente adiciona pontos, senão subtrai 1 ponto
				if (porganico >= 1) {
					...
					&& ((xObj <= lblPapel.getX() + 40) && (xObj >= lblPapel.getX() - 30))) { // colisão de cima com
																								// papel
				JOptionPane.showMessageDialog(null, "DEPOSITADO PAPEL");
				// se coletado 1 ou mais reciclaveis deste tipo e tocar na lixeira
				// correspondente adiciona pontos, senão subtrai 1 ponto
				if (ppapel >= 1) {
					...
					&& ((yObj <= lblReciclavel.getY()) && (yObj >= lblReciclavel.getY() - 60))) { // colisão de cima com
																									// reciclavel
				JOptionPane.showMessageDialog(null, "COLETADO UM RECICLAVEL");
				lblPontos.setText("Pontos: " + pontos); // atualiza a pontuação na tela
				switch (flagReciclaveis) { // dependendo do valor da variavel, escolhe um tipo de reciclavel
	...
	} // é acionado toda vez que o usuário digitar um caractere em algum elemento que
			...
			public void run() {
				...
				case 0:
					lblReciclavel.setIcon(new ImageIcon(
							...
							"C:\\Users\\Abner\\Documents\\Atividades%20Pr%C3%A1ticas%20Supervisionadas\\3º Semestre\\ColetaFeliz\\src\\RecMetal.png",
				...
				case 1:
					lblReciclavel.setIcon(new ImageIcon(
							...
							"C:\\Users\\Abner\\Documents\\Atividades%20Pr%C3%A1ticas%20Supervisionadas\\3º Semestre\\ColetaFeliz\\src\\RecPlastico.png",
				...
				case 2:
					lblReciclavel.setIcon(new ImageIcon(
							...
							"C:\\Users\\Abner\\Documents\\Atividades%20Pr%C3%A1ticas%20Supervisionadas\\3º Semestre\\ColetaFeliz\\src\\RecVidro.png",
				...
				case 3:
					lblReciclavel.setIcon(new ImageIcon(
							...
							"C:\\Users\\Abner\\Documents\\Atividades%20Pr%C3%A1ticas%20Supervisionadas\\3º Semestre\\ColetaFeliz\\src\\RecPapel.png",
				...
				case 4:
					lblReciclavel.setIcon(new ImageIcon(
							...
							"C:\\Users\\Abner\\Documents\\Atividades%20Pr%C3%A1ticas%20Supervisionadas\\3º Semestre\\ColetaFeliz\\src\\NoRec.png",
				...
				case 5:
					lblReciclavel.setIcon(new ImageIcon(
							...
							"C:\\Users\\Abner\\Documents\\Atividades%20Pr%C3%A1ticas%20Supervisionadas\\3º Semestre\\ColetaFeliz\\src\\RecOrganico.png",
