...
public class Modo_Facil extends JFrame implements KeyListener { // Implementa JFrame para parte visual e KeyListener para
    ...
    public void atualizarFundo() {
        lblBackground.setIcon(new ImageIcon("src\\imagens\\background.jpg"));
        lblBackground.setBounds(0, 112, 600, 380);
    ...
    public void inicializar() {
        ...
        lblSobre.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                JOptionPane.showMessageDialog(null, (new ImageIcon("src\\imagens\\Splash.png")), "Sobre:", JOptionPane.PLAIN_MESSAGE, null);
            }
        });
    ...
    public void keyPressed(KeyEvent e) { // m�todo para quando uma tecla for pressionada
        ...
        if (e.getKeyCode() == e.VK_LEFT) {
            ...
            if (xObj <= 0) {
            } else if ((yObj >= lblNaoReciclavel.getY() - 50) && (xObj <= lblNaoReciclavel.getX() + 55)) { // colisao de direita com não reciclavel
                ...
                if (pnrec >= 1) {
                    ...
                    && ((xObj <= lblOrganico.getX() + 55) && (xObj >= lblOrganico.getX()))) { // colis�o de direita com organico
                ...
                if (ppapel >= 1) {
                    ...
                    && ((yObj <= lblReciclavel.getY() + 25) && (yObj >= lblReciclavel.getY() - 45))) { // colis�o de direita com reciclavel
        ...
        if (e.getKeyCode() == e.VK_RIGHT) {
            ...
            if (xObj >= 555) {
            } else if ((xObj >= lblVidro.getX() - 38) && (yObj <= lblVidro.getY() + 48)) { // colis�o de esquerda com vidro
                ...
                if (pvidro >= 1) {
                    ...
                    && ((yObj <= lblMetal.getY() + 48) && (yObj >= lblMetal.getY() - 48))) { // colis�o de esquerda com metal
                ...
                if (pmetal >= 1) {
                    ...
                    && ((yObj <= lblPlastico.getY() + 48) && (yObj >= lblPlastico.getY() - 48))) { // colis�o de esquerda com plastico
                ...
                if (pplastico >= 1) {
                    ...
                    && ((xObj <= lblOrganico.getX()) && (xObj >= lblOrganico.getX() - 30))) { // colis�o de esquerda com organico
                JOptionPane.showMessageDialog(null, "DEPOSITADO ORGANICO");
                // se coletado 1 ou mais reciclaveis deste tipo e tocar na lixeira
                // correspondente adiciona pontos, sen�o subtrai 1 ponto
                if (porganico >= 1) {
            ...
            } else if ((yObj >= lblPapel.getY() - 40) && ((xObj <= lblPapel.getX()) && (xObj >= lblPapel.getX() - 40))) { // colicao de esquerda com papel
                JOptionPane.showMessageDialog(null, "DEPOSITADO PAPEL");
                // se coletado 1 ou mais reciclaveis deste tipo e tocar na lixeira
                // correspondente adiciona pontos, sen�o subtrai 1 ponto
                if (ppapel >= 1) {
                    ...
                    && ((yObj <= lblReciclavel.getY() + 25) && (yObj >= lblReciclavel.getY() - 45))) { // colis�o de esquerda com reciclavel
                JOptionPane.showMessageDialog(null, "COLETADO UM RECICLAVEL");
                lblPontos.setText("Pontos: " + pontos); // atualiza a pontua��o na tela
                switch (flagReciclaveis) { // dependendo do valor da variavel, escolhe um tipo de reciclavel
                    case 0:
            ...
            TimerTask tarefa = new TimerTask() {
                public void run() {
                    ...
                    if (contMinutos <= 1) {
                        ...
                        cancel();
                        JOptionPane.showMessageDialog(null, "         Sua pontuacao: " + pontos, "Game Over ", JOptionPane.PLAIN_MESSAGE, null);
                        Menu menu = new Menu(); // Chama tela menu
                        dispose();
                    }
                }
